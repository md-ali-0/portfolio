    ...
    <div className="min-h-screen bg-zinc-950 text-white flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(circle at 30% 30%, rgba(59, 130, 246, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(16, 185, 129, 0.08) 0%, transparent 60%)",
              "radial-gradient(circle at 60% 20%, rgba(59, 130, 246, 0.12) 0%, transparent 50%), radial-gradient(circle at 40% 80%, rgba(16, 185, 129, 0.1) 0%, transparent 60%)",
              "radial-gradient(circle at 30% 30%, rgba(59, 130, 246, 0.1) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(16, 185, 129, 0.08) 0%, transparent 60%)",
            ],
          }}
          transition={{
      ...
      <div className="text-center max-w-md mx-auto relative z-10">
        ...
        >
          ...
          >
            <span className="absolute inset-0 bg-clip-text text-transparent bg-gradient-to-r from-blue-400/20 via-emerald-300/20 to-blue-500/20 blur-sm scale-110">
              405
            </span>
            <motion.span
              className="relative bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-emerald-300 to-blue-500"
              animate={{
        ...
        >
          The request method is not supported for this resource. Please check your request and try again.
        </motion.p>
