...
export default function BlogCard({
    ...
    return (
        <Link href={`/blog/${post.slug}`} className="block">
            <div className="relative bg-gradient-to-br from-zinc-900/80 via-zinc-800/60 to-zinc-900/40 backdrop-blur-2xl rounded-2xl overflow-hidden h-full border border-zinc-800/50 hover:border-emerald-500/50 transition-all duration-300">
                {/* Content wrapper */}
                <div className="relative z-10">
                    ...
                    <div className="relative h-56 overflow-hidden rounded-t-2xl">
                        ...
                        <div className="absolute top-4 left-4">
                            <Badge className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white border-0 text-xs font-semibold px-3 py-1.5">
                                {post.category}
                            </Badge>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-zinc-800/50">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="relative">
                                    <div className="relative w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-500 flex items-center justify-center text-white text-sm font-bold">
                                        MA
                                    </div>
                                </div>
                            ...
                            <Button
                                variant="ghost"
                                size="sm"
                                className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 text-emerald-400"
                            >
