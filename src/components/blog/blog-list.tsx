...
export default function BlogList({
    ...
    const [projects, setProjects] = useState<Post[]>(initialProjects);
    ...
    return (
        <>
            ...
            >
                {projects.map((project: Post, index) => (
                    <BlogCard post={project} key={index} index={index} />
                ))}
                {loading && (
