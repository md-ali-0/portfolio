                            ...
                            >
                                ...
                                <motion.div
                                    className={`absolute inset-0 bg-gradient-to-br from-${
                                        skill.color
                                    }-500/10 via-transparent to-${
                                        skill.color === "emerald"
                                            ? "teal"
                                            : skill.color === "teal"
                                            ? "emerald"
                                            : "cyan"
                                    }-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                                    animate={{
                                        backgroundPosition: [
                                            "0% 0%",
                                            "100% 100%",
                                ...
                                <motion.div
                                    className={`absolute inset-0 rounded-2xl bg-gradient-to-r from-${
                                        ...
                                        skill.color === "emerald"
                                            ...
                                            ? "emerald"
                                            : "cyan"
                                    }-400/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl`}
                                    animate={{
                                        scale: [1, 1.05, 1],
                                    }}
                                    transition={{
